  ...
  conditions: [
    {
      ...
      query: 'https://arbigates/api/verify?address=${address}&gateId=242',
    },
    {
      ...
      query: 'https://arbigates/api/verify?address=${address}&gateId=321',
    },
    {
      ...
      query: 'https://arbigates/api/verify?address=${address}&gateId=871',
    },
  ],
};
